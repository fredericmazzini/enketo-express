...
module.exports = function( grunt ) {
    ...
    grunt.registerTask( 'widgets', 'generate widget reference files', function() {
        var content;
        var WIDGETS_JS = 'public/js/src/module/widgets.js';
        var WIDGETS_SASS_LOCATION = 'app/views/styles/component/';
        var WIDGETS_SASS = WIDGETS_SASS_LOCATION + '_widgets.scss';
        ...
        content = PRE +
            paths.map( function( path ) {
                return ( grunt.file.exists( WIDGETS_SASS_LOCATION, path + '.scss' ) ) ? '@import "' + path + '"' : '//' + path + ' not found';
            } ).join( ';\n' ) + ';';
